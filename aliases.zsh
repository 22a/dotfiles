...
alias rss="OBJC_DISABLE_INITIALIZE_FORK_SAFETY=YES ./bin/rails s"
alias i="git pull; bundle install; se && rss"
alias e="git pull; yarn; yarn start"
alias n="git pull; sup; s"
alias cys="yarn install --check-files; rm -rf tmp dist; ember s"
